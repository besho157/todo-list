            ...
            <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
                <div className="w-full p-8 lg:w-1/2">
                    ...
                    <div className="mt-4">
                        ...
                        <input className="bg-gray-200 text-black focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="email" placeholder='Enter your email...' />
                    </div>
                    <div className="mt-4">
                        ...
                        <input className="bg-gray-200 text-black focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="password" placeholder='Enter your password...' />
                    </div>
                    <div className="mt-8">
                        <button className="bg-blue-600 text-white font-bold py-2 px-4 w-full rounded hover:bg-blue-800">Sign up</button>
                    </div>
                    <div className="mt-4 flex items-center justify-center">
                        <span>Already signed up?
                            <Link href="/login" className="text-xs text-blue-800 uppercase">  Go to login</Link>
                        </span>
                    </div>
                </div>
                <div className="hidden lg:block lg:w-1/2 h-[700] bg-no-repeat  bg-center"
                    style={{ backgroundImage: "url('https://img.freepik.com/free-vector/completed-concept-illustration_114360-2945.jpg?semt=ais_hybrid&w=740')" }}>
                </div>
            </div>
        </form>
    )
