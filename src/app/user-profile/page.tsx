                ...
                <div className="text-center space-y-6">
                    ...
                    <div className="mt-6">
                        <button
                            ...
                            className="group relative inline-flex items-center justify-center overflow-hidden rounded-lg border-2 border-blue-600 px-6 py-2 font-semibold text-blue-400 transition-all duration-300 hover:bg-blue-600 hover:text-white"
                        >
                            <span className="absolute left-0 top-0 h-full w-0 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
                            <span className="relative text-blue-600 z-10 flex items-center gap-2">
                                <svg
                                    className="w-5 h-5"
                                    fill="none"
                                    stroke="currentColor"
